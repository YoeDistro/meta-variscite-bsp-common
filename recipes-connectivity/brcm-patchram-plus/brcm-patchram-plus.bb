...
LIC_FILES_CHKSUM = "file://${UNPACKDIR}/brcm_patchram_plus.c;md5=8730e07b5fe13575c21ef01769aa5b01"
SRC_URI = "file://brcm_patchram_plus.c"

do_compile() {
        ${CC} ${CFLAGS} ${LDFLAGS} -o brcm_patchram_plus ${UNPACKDIR}/brcm_patchram_plus.c
}
